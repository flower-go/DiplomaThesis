...
\end{center}
Data contains about 1,600 unique tags and 15k different lemma rules. The number of lemmas is significantly smaller than a number of unigue lemmas -- 72K \citep{Strakova} or tags, because words with simiral morphological function have same way of creating lemma from the word, e.g. words \textit{malého} (little, accusative,  sg, m.,) and \textbf{červeného}  (red, accusative,  sg, m.,) have same lemma rule:
\begin{center}
\texttt{$\downarrow 0;d$ \textbrokenbar ---+$\acute{y}$+-+1}.
\end{center} 
\par
...
%TODO a jeste jak to bylo udelane v robecku jinak
\begin{table}[!h]
...
\multirow{2}{*}{Experiment} & \multicolumn{3}{c||}{Without Dictionary}  &
    ...
    StrakaC & 97.67 & 98.63 & 97.02 & 97.91 & 98.94 & 97.51 \\ \hline
     RobeCzech & 98.43 & 98.79  & 97.83  & 98.50 & \textbf{99.00}  & 98.11 \\ \hline
