...
Batches has size 64, given by the compromise between the pursuit of relatively big batch size and computational resources. Complete set of hyperparameters for each experiment are in Appendix %TODO doplnit

\subsection{Results and Discussion}
%TODO jaka je baseline
%Jsou vysledky lepsi nez baseline? O kolik procent? ktery model je nejlepsi a cekali jsme to? Cekali jsme jak budou ostatni slabe? (dle kategorií) Kde jsou vsechny vysledky
%TODO udelat tabulku do příloh
%TODO úusteno na pokusny vstup, chci se kounout na masky!
...
%TODO jake chyby dela baseline a jake best model?
61 lemma errors and 1046 tag error in test data were removed by best model in contrast to baseline. %TODO prilozit
%TODO jak vypsat cele vety 
%TODO jake chyby best a jake best mBERT? best mBERT je tl_3
