...
\begin{table}[]
\centering
\resizebox*{!}{\textheight-2pt}{\begin{tabular}{|l|l|l|l|l||ll|}
\hline
\multicolumn{2}{|l|}{MODEL}       & EXPE                  & LAYERS    & LRTYPE                & Acc    & F1   \\ \hline  \hline
1  & \multirow{6}{*}{mBERT}     & czech                     & \multirow{6}{*}{four}  & \multirow{3}{*}{isrd} & 80.89   & 80.62 \\ \cline{1-1} \cline{3-3} \cline{6-7}
2  &                            & zero                      &   &                       & 49.51   & 44.67 \\ \cline{1-1} \cline{3-3} \cline{6-7}
3  &                            & eng                       &   &                       & 81.17   & 80.90 \\ \cline{1-1} \cline{3-3}\cline{5-7}
4  &                            & czech                     &   & \multirow{3}{*}{cos}  & 82.56   & 82.35 \\ \cline{1-1} \cline{3-3} \cline{6-7}
5  &                            & zero                      &   &                       & 53.41   & 47.64 \\ \cline{1-1} \cline{3-3} \cline{6-7}
6  &                            & eng                       &   &                       & 82.55   & 82.37 \\ \hline
13 & \multirow{4}{*}{RoBECzech} & czech                     &  \multirow{4}{*}{four}  & \multirow{2}{*}{isrd} & 81.17   & 80.90 \\ \cline{1-1} \cline{3-3} \cline{6-7}
14 &                            & zero                      &   &                       & 55.31   & 48.26 \\ \cline{1-1} \cline{3-3}\cline{5-7}
16 &                            & czech                     &   & \multirow{2}{*}{cos}  & 84.04   & 83.86 \\ \cline{1-1} \cline{3-3} \cline{6-7}
17 &                            & zero                      &   &                       & 57.64   & 48.79 \\ \hline
19 & \multirow{6}{*}{mBERT}     & czech                     & \multirow{6}{*}{att}  & \multirow{3}{*}{isrd} & 81.61   & 81.43 \\ \cline{1-1} \cline{3-3} \cline{6-7}
20 &                            & zero                      &   &                      & 53.92   & 47.55 \\ \cline{1-1} \cline{3-3} \cline{6-7}
