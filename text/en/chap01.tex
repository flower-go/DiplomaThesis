...
A history of neural networks started in 1940s %todo deep learning book. 
...
In Transformers architecture %todo zdroj
, which is relevant to this work, self-attention mechanism is used. This variant of attention do not connect one part of text (like question) to other different part of text (like answer), but only models relationships inside one sentence. %todo obrazek z videa
